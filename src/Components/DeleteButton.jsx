...
const Delete = ({id, onDelete}) => {
    ...
    return (
        <button onClick={()=>onDelete(true, id)} className='font-[500] gap-1 flex flex-row justify-center items-center fill-soft-red hover:fill-pale-red  text-soft-red hover:text-pale-red'>
