...
const Reply = ({onClickReply}) => {
    return (
        <button onClick={()=>onClickReply(true)} className='flex flex-row justify-center items-center fill-moderate-blue hover:fill-light-grayish-blue text-moderate-blue hover:text-light-grayish-blue'>
