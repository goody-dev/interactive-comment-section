...
const Reply = ({onClickReply, id}) => {
    return (
        <button onClick={()=>onClickReply(true, id)} className='flex flex-row justify-center items-center fill-moderate-blue hover:fill-light-grayish-blue text-moderate-blue hover:text-light-grayish-blue'>
            ...
            <p className='ms-1 font-[500]'>Reply</p>
        </button>
    )
}
