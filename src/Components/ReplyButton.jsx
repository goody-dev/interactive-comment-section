...
const Reply = ({onClickReply, id, replyEditorVisibility, focusCommentId}) => {
    ...
    return (
        <button onClick={()=>handleClick()} className='font-[500] gap-1 flex flex-row justify-center items-center fill-moderate-blue hover:fill-light-grayish-blue text-moderate-blue hover:text-light-grayish-blue'>
