...
const EditEditor = ({onUpdate, comment, commentId, handleEditEditor}) => {
  ...
  return (
    <div className="flex flex-col mx-auto w-[100%] justify-end rounded gap-3">
      ...
      <button onClick={handleUpdate} className="bg-moderate-blue hover:bg-light-grayish-blue text-white rounded p-1 w-20 h-fit md:h-10">UPDATE</button>
    </div>
  )
}
